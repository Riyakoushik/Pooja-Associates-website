    ...
    <section className="bg-white py-[120px] w-full flex flex-col items-center overflow-hidden">
      <div className="container max-w-[1200px] px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
          {/* Other Firms Card */}
          <div className="bg-brand-off-white border border-border rounded-[24px] overflow-hidden flex flex-col p-[40px] shadow-[0px_4px_20px_rgba(0,0,0,0.05)]">
            <div className="mb-10">
              ...
              {otherFirmsFeatures.map((feature, index) => (
                <div key={index} className="flex gap-4">
                  <div className="flex-shrink-0 mt-1">
                    <div className="w-10 h-10 rounded-full flex items-center justify-center border border-border bg-white">
          ...
          {/* With Stratex Card */}
          <div className="bg-primary border border-primary rounded-[24px] overflow-hidden flex flex-col p-[40px] shadow-[0px_4px_20px_rgba(0,0,0,0.1)]">
            <div className="mb-10">
