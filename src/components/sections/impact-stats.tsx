  ...
  return (
    <section className="bg-white py-[120px] overflow-hidden">
      <div className="container mx-auto px-6">
        <AnimatedSection className="flex flex-col items-center text-center mb-16 max-w-[800px] mx-auto">
        ...
        <div className="relative flex justify-center items-center mt-20 h-[500px] max-w-[800px] mx-auto">
          <AnimatedSection delay={200} className="relative w-[300px] h-[450px] rounded-[40px] overflow-hidden z-10 shadow-sm border border-[#E6E6E6] group">
            <Image
          ...
          {stats.map((stat, idx) => {
            ...
            return (
              ...
              >
                <div className={`flex items-center gap-2 bg-[#1A4D43] rounded-full py-1.5 px-3 shadow-md min-w-[120px] transition-all duration-500 hover:scale-110 hover:shadow-xl cursor-default ${isLeft ? 'flex-row' : 'flex-row-reverse'}`}>
                ...
                <div 
                  className={`hidden md:block absolute h-[1px] bg-[#E6E6E6] rounded-full transition-all duration-500 ${stat.lineWidth} ${isLeft ? 'left-[calc(100%-8px)]' : 'right-[calc(100%-8px)]'}`}
                  style={{
                    top: '50%',
